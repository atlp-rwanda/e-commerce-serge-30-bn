...
export const createProfile = async (inputs: createdFields): Promise<Profile | null > => {
 try {
...
export const modifyProfile = async (updateUserInputs: UpdateUserInputs): Promise<Profile | null> => {
  try {
